...
if(isset($_POST['save']))
{
    ...
    {
        $search = $_POST['search'];
        $stmt = $con->prepare("select * from user_table2 where first_name like '%$search%' or last_name like '%$search%'");
        $stmt->execute();
    ...
    <body>
        ...
        <div class="row">
            <div class="form-group">
                <label class="text-blue-600" for="email"><b>Search Information:</b>:</label>
                <div class="col-sm-4">
                  <input type="text" class="form-control" name="search" placeholder="search here">
                </div>
                <div class="col-sm-2">
                  <button type="submit" name="save" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mx-4">Submit</button>
                </div>
            </div>
            <div class="form-group">
