...
<div class="grid grid-cols-3 px-32 py-16">
    <div class="col-span-1 flex flex-col text-center text-white items-center">
        ...
        <p>Play like you mean it with men’s football cleats. 
            When you’re speeding across the field in supportive gear built for speed and comfort, the game will belong to you.</p>
