...
<div style='display: flex; width: 100vw;' class='justify-center'>
    ...
    <div class="grid grid-cols-3 px-32 py-16 gap-12">
        <div class="col-span-1 flex flex-col text-center text-white items-center">
            ...
            <a href="Adidas Football Shoes.php" class="bg-green-500 text-white px-4 py-2 rounded-lg mt-4">More
                Details</a>
            <br>
        </div>
        <div class="col-span-1 flex flex-col text-center text-white items-center">
        ...
        <div class="col-span-1 flex flex-col text-center text-white items-center">
            ...
            <a href="Adidas Football Shoes(Messi).php" class="bg-green-500 text-white px-4 py-2 rounded-lg mt-4">More
                Details</a>
            <br>
        </div>
        <div class="col-span-1 flex flex-col text-center text-white items-center">
            ...
            <a href="Adidas Football Shoes(MS10).php" class="bg-green-500 text-white px-4 py-2 rounded-lg mt-4">More
                Details</a>
            <br>
        </div>
        <div class="col-span-1 flex flex-col text-center text-white items-center">
            ...
            <a href="Barcelona Match Jersey.php" class="bg-green-500 text-white px-4 py-2 rounded-lg mt-4">More
                Details</a>
            <br>
        </div>
        <div class="col-span-1 flex flex-col text-center text-white items-center">
            ...
            <a href="Barcelona Nike Football.php" class="bg-green-500 text-white px-4 py-2 rounded-lg mt-4">More
                Details</a>
            <br>
        </div>
        <div class="col-span-1 flex flex-col text-center text-white items-center">
            ...
            <a href="Barcelona Nike Football(LW10).php" class="bg-green-500 text-white px-4 py-2 rounded-lg mt-4">More
                Details</a>
            <br>
        </div>
        <div class="col-span-1 flex flex-col text-center text-white items-center">
        ...
        <div class="col-span-1 flex flex-col text-center text-white items-center">
            ...
            <a href="Adidas Shoes(Long-Messi).php" class="bg-green-500 text-white px-4 py-2 rounded-lg mt-4">More
                Details</a>
            <br>
        </div>
    </div>
