...
<?php
    ...
    $visited_services->enqueue("Adidas Football Shoes(Messi).php");
    ...
    if (isset($_COOKIE['visit_count'])) {
        ...
        if (array_key_exists("Adidas Football Shoes(Messi)", $visit_count)) {
            $visit_count["Adidas Football Shoes(Messi)"] += 1;
        } else {
            $visit_count["Adidas Football Shoes(Messi)"] = 1;
        }
    } else {
